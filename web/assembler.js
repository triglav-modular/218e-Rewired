...
// Pitch-aware latch: latched notes are pitches held in slots.  A slot k
        ...
        emit("MOV PC,R8");
        padTo(0x8001b564);
        word(0x80005660); // the factory poly note-on/note-off handler
        finish("seq_poly_mute", 0x8001b568);
        ...
        wordPatch("poly_note_pool", 0x80005644,
            block("seq_pitch") ? 0x8001b550 : 0x80005660,
