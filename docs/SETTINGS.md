...
boot, and the page writes that record over Web MIDI from step 3 and reads
it back from the box between steps 1 and 2. Changing an option costs a MIDI push and a restart the page sends,
