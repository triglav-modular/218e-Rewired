...
// Pitch-aware latch: latched notes are pitches held in slots.  A slot k
        ...
        emit(String.format("MOV R11,0x%x", number("scan_period_ms", 5, 1, 20)));
        ...
        finish("seq_noteoff", 0x8001b918L);
        ...
        word(0x8001b700L);              // the external clock, per scan
        padTo(0x8001a534L);
        word(0x00003560L); // global state base
